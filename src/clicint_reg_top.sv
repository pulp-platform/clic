...
module clicint_reg_top #(
  ...
  logic [2:0] clicint_attr_regs_qs;
  logic [2:0] clicint_attr_regs_wd;
  logic clicint_attr_regs_we;
  ...
  prim_subreg #(
    ...
    // from register interface
    .we     (clicint_attr_regs_we),
    .wd     (clicint_attr_regs_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.clicint.attr_regs.q ),

    // to register interface (read)
    .qs     (clicint_attr_regs_qs)
  );
  ...
  assign clicint_attr_regs_we = addr_hit[0] & reg_we & !reg_error;
  assign clicint_attr_regs_wd = reg_wdata[21:19];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      addr_hit[0]: begin
        ...
        reg_rdata_next[21:19] = clicint_attr_regs_qs;
